...
resource "aws_lb_listener" "http_listener" {
  load_balancer_arn = aws_lb.cis_web.arn
  port              = 443
  protocol          = "HTTPS"
...
#resource "aws_wafv2_web_acl_association" "cis_web_waf_assoc" {
#  resource_arn = aws_lb.cis_web.arn
...
resource "aws_wafv2_web_acl_association" "alb_waf_attachment" {
  resource_arn = aws_lb.cis_web.arn
  web_acl_arn  = data.aws_wafv2_web_acl.web_acl.arn
}
